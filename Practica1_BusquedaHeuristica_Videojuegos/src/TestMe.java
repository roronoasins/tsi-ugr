...
public class TestMe {
    ...
    public static void main(String[] args) {
		...
		String myController = "src_gonzalez_romero_luis.Agent";
		...
		for(int i=0; i < 2000; i++)
		{
			...
			double[] a = ArcadeMachine.runOneGame(game, level1, visuals, myController, recordActionsFile, seed, 0);

			if(a[0] == 1)
				var++;
			time += a[a.length-1];
		}
		System.out.println(var/2000.0);
        System.out.println(time/2000.0);
